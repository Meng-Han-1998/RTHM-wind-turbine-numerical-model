...
REAL (Reki)          ,SAVE :: PtfmMomAQWA(3)                    ! Platform moment due to tower base forces in the tower base coordinate system 
REAL (Reki)          ,SAVE :: PtfmMomAQWA_Yaw                   ! Platform moment due to tower base forces in the tower base coordinate system
REAL (Reki)          ,SAVE :: PtfmFrcAQWA(3)                    ! Platform forces due to tower base forces in the tower base coordinate system
LOGICAL              ,SAVE :: CouplingAQWA                      ! Coupling flag between OpenFAST & AQWA 
