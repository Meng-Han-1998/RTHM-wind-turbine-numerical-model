!**********************************************************************************************************************************
SUBROUTINE OpenFAST_WT(MODE_O,STAGE_O,TIME_O,TIMESTEP_O,PtfmMotAQWA_In,PtfmVelAQWA_In,PtfmCog_In,PtfmFrcAQWA_Out,PtfmMomAQWA_Out)
...
INTEGER(IntKi),         INTENT(IN   ) :: MODE_O                                  ! Status of the simulation. 0: Initilize FAST. 1: Run time marching in FAST. 99: Terminate FAST
INTEGER(IntKi),         INTENT(IN   ) :: STAGE_O                                 ! The stage of the AQWA integration scheme. Output the FAST results at the current time step with STAGE=1
REAL,                   INTENT(IN   ) :: TIME_O                                  ! The current time
REAL,                   INTENT(IN   ) :: TIMESTEP_O                              ! The timestep size
...
REAL(ReKi)                            :: PtfmVelAQWA_Sq(6)                      ! Square of Platform reference point acceleration
REAL(Reki)                      ,SAVE :: PtfmVelAQWA_Last(6)                     ! Platform velocity at the current time step
REAL(Reki)                      ,SAVE :: AddBQuad_O(6,6)                         ! Additional quadratic drag(N/(m/s)^2, N/(rad/s)^2, N-m(m/s)^2, N-m/(rad/s)^2)
...
INTEGER(IntKi)                        :: J                                       ! Indicator for calculation
...
INTEGER(IntKi)                        :: UnOuPM_COG  = 10003                     ! I/O unit of the output file containing the motions of the platform COG
INTEGER(IntKi)                        :: UnOuPM_RE   = 10004                     ! I/O unit of the output file containing the motions of the platform reference point
INTEGER(IntKi)                        :: UnOuTBF     = 10005                     ! I/O unit of the output file containing the tower base forces in the tower base coordinate system
INTEGER(IntKi)                        :: UnOuPF_COG  = 10006                     ! I/O unit of the output file containing the platform forces acting at the platform COG due to tower base forces in the global coordinate system
INTEGER(IntKi)                        :: UnOuDF_COG  = 10007                     ! I/O unit of the output file containing the platform forces acting at the platform COG due to Additional quadratic drag in the global coordinate system
...
!   WRITE(UnTout,'(A20,F10.3)')  'PtfmRefzt(m)',Turbine(1)%ED%p%PtfmRefzt
!   WRITE(UnTout,'(A20,F10.3)')  'DT(s)',Turbine(1)%p_FAST%DT
!   !WRITE(UnTout,'(A20,F10.3)')  '2DT(s)',Turbine(1)%p_FAST%DT*2.0
!   !WRITE(UnTout,'(A20,F10.3)')  'TIMESTEP(s)',TIMESTEP_O
!   !WRITE(UnTout,'(A20,F10.3)')  'iStps',NINT (TIMESTEP_O/((Turbine(1)%p_FAST%DT*2.0)))
!CLOSE (UnTout) 
  !...............................................................................................................................
   ! Time Stepping:
   !...............................................................................................................................         
...
CONTAINS
   ...
   SUBROUTINE   Tower_base_Loads_Trans()
     ...
     WRITE(UnOuPF_COG,'(F10.3,6(ES20.6))') n_t_global*Turbine(1)%p_FAST%DT,(PtfmFrcAQWA_Out(I),I=1,3),(PtfmMomAQWA_Out(I),I=1,3)
     ...
     PtfmMomAQWA_Out(1) = PtfmMomAQWA_Out(1) + AddedPtfmLds_Damp(4)
     PtfmMomAQWA_Out(2) = PtfmMomAQWA_Out(2) + AddedPtfmLds_Damp(5)
     PtfmMomAQWA_Out(3) = PtfmMomAQWA_Out(3) + AddedPtfmLds_Damp(6)
